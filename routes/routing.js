...
router.get('/getAllTreeBotNames', jsonencodedParser, function (req, res) {
    Trees.retrieveAllTreeBotNames()
        .then(function (docs) {
            res.send(docs);
        })
        .catch(function (error) {
...
router.get('/getAllShrubBotNames', jsonencodedParser, function (req, res) {
    Shrubs.retrieveAllShrubBotNames()
        .then(function (docs) {
            res.send(docs);
        })
        .catch(function (error) {
